...
time.sleep(6)
writer("Type 'Enter' to next step: ")
input()
...
writer("Type 'Enter' to next step: ")
input()
writer("\033[32mOpening WhatsApp")
...
writer("\033[33mEnter maximum password length (default 99999): ")
max_password_length = int(input() or "99999")
